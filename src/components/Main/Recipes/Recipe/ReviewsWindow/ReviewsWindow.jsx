...
import { loadComments, postComment, reviewsClose } from '../../../../../redux/ducks/reviewsReducer'
    ...
    <div className={classes.modal}>
      <div className={classes.modalContent}>
        ...
        <div className={classes.text}>
          {loadingComments ? (
            <div className={classes.load}><ReactLoading type={'spin'} color={'#7729b7'} height={25} width={25} /></div>
          ) : (
        ...
        <div>
          ...
          <div>
            <button onClick={() => handlePostComment(commentId, comments.length, name, comment)}>
              Отправить
            </button>
          </div>
        </div>
